...
module.exports = {
  ...
  "OWNER_NUMBER": process.env.OWNER_NUMBER || "07042436090",
  "OWNER_NAME": process.env.OWNER_NAME || "Immanuel",
  "ALWAYS_ONLINE": process.env.ALWAYS_ONLINE === 'false',
  "PRESENCE": process.env.PRESENCE || "offline",
  ...
  "COUNTRY_BLOCK_CODE": process.env.COUNTRY_BLOCK_CODE || "false",
